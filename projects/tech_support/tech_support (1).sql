...
--
-- Host: localhost:3306
-- Generation Time: Oct 19, 2023 at 04:35 AM
...
(1002, 'Kelly', 'Irvin', 'PO Box 96621', 'Washington', 'DC', '20090', 'US', '(301) 555-8950', 'kelly@example.com', 'sesame1'),
...
(28, 1117, 'TRNY20', 11, '2014-06-14 00:00:00', '2023-09-08 04:26:51', 'Error importing data', 'Received error message 415 while trying to import data from previous version.'),
...
(42, 1097, 'TRNY20', 11, '2014-07-08 00:00:00', NULL, 'Unable to import data', 'Import command not available for importing data from previous version.'),
(44, 1063, 'LEAG10', NULL, '2014-07-09 00:00:00', '2023-09-19 05:36:40', 'Installation error', 'Error during installation: cmd.exe not found.'),
(45, 1089, 'LEAGD10', 11, '2014-07-09 00:00:00', NULL, 'Problem upgrading from League Scheduler 1.0', 'Program fails with error 303 when trying to install upgrade.'),
(46, 1016, 'TEAM10', 11, '2014-07-09 00:00:00', NULL, 'Unable to restore data from backup', 'Error 405 encountered while restoring backup: File not found.'),
(47, 1034, 'DRAFT10', 11, '2014-07-09 00:00:00', NULL, 'Can\'t activate product', 'Product activation code invalid.'),
(48, 1049, 'TRNY20', 11, '2014-07-09 00:00:00', NULL, 'Unable to print brackets', 'Program doesn\'t recognize printer.'),
(49, 1083, 'LEAGD10', 14, '2014-07-10 00:00:00', NULL, 'Can\'t start application', 'Error 521 on startup: database must be reorganized.'),
(50, 1116, 'DRAFT10', 11, '2014-07-10 00:00:00', NULL, 'Error during data file backup', 'Program abends with error 228 during database backup'),
(51, 1067, 'LEAGD10', NULL, '2014-07-10 00:00:00', '2023-09-08 03:50:27', 'Error when adding new records', 'Received error 340: database exceeds size limit.'),
(52, 1066, 'TEAM10', NULL, '2014-07-11 00:00:00', '2023-09-08 03:49:08', 'Installation problem', 'Customer states that the setup program failed with code 203 during configuration.');
...
('TEST 40', 'TEST 40', '1.1', '2023-02-02'),
('TEST10', 'TestCode', '1.0', '2012-01-01'),
('TEST30', 'TEST30', '1.1', '2023-02-02'),
('TEST50', 'Test50', '1.0', '2019-01-01'),
('TEST70', 'Test70', '1.0', '2019-01-01'),
('TEST71', 'Test71', '1.0', '2012-01-01'),
('TEST72', 'Test72', '1.0', '2001-01-02'),
('TEST73', 'Test73', '1.0', '2023-09-10'),
('TEST75', 'Test75', '1.0', '2012-01-01'),
...
(1002, 'DRAFT10', '2023-09-19 03:17:14'),
(1002, 'DRAFT20', '2023-09-19 03:21:19'),
(1002, 'LEAG10', '2012-11-01 00:00:00'),
(1002, 'LEAGD10', '2023-09-19 03:18:50'),
(1002, 'TEAM10', '2023-09-19 03:16:53'),
(1002, 'TEST30', '2023-09-19 05:19:06'),
(1002, 'TEST40', '2023-09-19 05:26:47'),
(1002, 'TEST50', '2023-09-19 05:04:46'),
(1002, 'TEST70', '2023-09-19 05:10:07'),
(1002, 'TEST71', '2023-09-19 05:13:11'),
(1002, 'TEST72', '2023-09-19 05:12:43'),
(1002, 'TEST73', '2023-09-19 05:16:01'),
(1002, 'TEST75', '2023-09-19 05:18:01'),
(1002, 'TRNY20', '2023-09-19 04:42:18'),
